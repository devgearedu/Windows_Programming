object MainForm: TMainForm
  ...
  object GridPanel1: TGridPanel
    ...
    ColumnCollection = <
      item
        Value = 1.206900706440391000
      end
      item
        Value = 97.586198587119230000
      end
      item
        Value = 1.206900706440381000
      end>
    ControlCollection = <
      item
        Column = 1
  ...
  object ActionManager1: TActionManager
    ActionBars = <
      ...
      item
        Items = <
          ...
          item
            Action = About_Static_Action
            Caption = 'Add '#54632#49688' '#54840#52636'(Dll '#51221#51201#54840#52636')(&D)'
            ImageIndex = 19
            ImageName = 'Item20'
          end
          item
            Action = About_Dynamic_Action
            Caption = 'Divide '#54632#49688' '#54840#52636'(Dll '#46041#51201#54840#52636')(&I)'
            ImageIndex = 19
            ImageName = 'Item20'
          end
          item
            Action = About_Package_Action
            Caption = #54868#47732' '#54364#49884'('#47088#53440#51076#54056#53412#51648')(&Y)'
            ImageIndex = 19
            ImageName = 'Item20'
          end
          item
    ...
    object About_Static_Action: TAction
      Category = #44592#53440
      Caption = 'Add '#54632#49688' '#54840#52636'(Dll '#51221#51201#54840#52636')'
      Hint = 'Add '#54632#49688' '#54840#52636'(Dll '#51221#51201#54840#52636')'
      ImageIndex = 19
      ImageName = 'Item20'
      OnExecute = About_Static_ActionExecute
    end
    object About_Dynamic_Action: TAction
      Category = #44592#53440
      Caption = 'Divide '#54632#49688' '#54840#52636'(Dll '#46041#51201#54840#52636')'
      Hint = 'Divide '#54632#49688' '#54840#52636'(Dll '#46041#51201#54840#52636')'
      ImageIndex = 19
      ImageName = 'Item20'
      OnExecute = About_Dynamic_ActionExecute
    end
    object About_Package_Action: TAction
      Category = #44592#53440
      Caption = #54868#47732' '#54364#49884'('#47088#53440#51076#54056#53412#51648')'
      Hint = #54868#47732' '#54364#49884'('#47088#53440#51076#54056#53412#51648')'
      ImageIndex = 19
      ImageName = 'Item20'
      OnExecute = About_Package_ActionExecute
    end
  end
